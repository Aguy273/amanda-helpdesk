...
import { Send, Phone, Video, Info, Smile, Paperclip, ImageIcon, FileText } from "lucide-react"
  ...
  return (
    <div className="flex-1 flex flex-col bg-white">
      ...
      <div ref={chatContainerRef} className="flex-1 p-4 overflow-y-auto space-y-4 bg-gray-50">
        ...
        {conversationMessages.length === 0 ? (
          <div className="text-center text-gray-500 py-10">Start a conversation with {selectedUser?.name}</div>
        ) : (
          conversationMessages.map((msg) => {
