...
export default function AdminUsersPage() {
  const { user, isAuthenticated, getAllUsers, addUser, updateUserById, deleteUser } = useUserStore()
  ...
  // Admin can only see and manage staff users, not master or other admins
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Navbar showReports showChat showUsers />
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {staffUsers.map((staffUser) => (
                  <tr key={staffUser.id} className="hover:bg-gray-50 transition-colors duration-200">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{staffUser.email}</td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          {staffUsers.length === 0 && (
            <div className="p-8 text-center">
              <p className="text-gray-500">Belum ada staff yang terdaftar</p>
            </div>
          )}
        </div>
